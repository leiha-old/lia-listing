...
namespace Lia\ListingBundle\Library\Column;
    ...
    public function __construct(){
        parent::__construct(
            array(
                ...
                array(
                    'name'     => 'hooks',
                    'classBag' => 'Lia\ListingBundle\Library\Column\HooksBag'
                ),
                array(
                    'name'     => 'actions',
                    'classBag' => 'Lia\ListingBundle\Library\Column\ActionsBag'
                ),
                array(
                    'name'     => 'templates',
                    'classBag' => 'Lia\ListingBundle\Library\Column\TemplatesBag'
                )
            )
        );
